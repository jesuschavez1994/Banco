...
@Component({
  ...
  templateUrl: './desincronizar.component.html',
  styleUrls: ['./desincronizar.component.css']
})
export class DesincronizarComponent implements OnInit {
...

        {
          ...
          this.route.params.subscribe( (params: Params) => {
            ...
            this.storeService.getSpecificProduct(localStorage.getItem('id'), localStorage.getItem('storeId'),this.idProduct).subscribe( (data: EditProductStore) => {
              ...
              this.myFlag = true;
              this.sync = 'sync';
              this.IdSync = data.sync_bank[0].id;
              this.valorForm = data;
              ...
              this.forma.get('price').disable();
              this.forma.get('delivery').disable();
              this.forma.get('aviable').disable();
              this.forma.get('stock').disable();
              this.forma.get('recipe').disable();
  ...
  Send(){
    ...
    this.sincronizacion.Desincronizar(
      localStorage.getItem('id'),
